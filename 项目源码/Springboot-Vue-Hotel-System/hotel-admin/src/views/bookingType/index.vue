  ...
  <el-card class="box-card" shadow="always">
    <div slot="header">
      ...
      <el-input v-model="searchData" placeholder="请输入预订方式">
        <el-button slot="append" type="" icon="el-icon-search" @click="search">搜索</el-button>
      </el-input>
    </div>
    <el-table
      ref="multipleTable"
        ...
        <template slot-scope="scope">
          ...
          <el-popover
            ...
            <div style="text-align: right; margin: 0">
              ...
              <el-button type="" size="mini" round @click="handleDel(scope.row)">确定</el-button>
            </div>
            <el-button slot="reference" :loading="scope.row.loading" size="mini" type="" @click="scope.row.visible2 = true">删除</el-button>
          </el-popover>
        </template>
      </el-table-column>
    </el-table>
    <div style="padding: 14px;">
      <div class="bottom">
        <el-button type="" @click="handleAdd()">添加预订方式</el-button>
        <el-dialog :visible.sync="dialogFormVisible" title="添加预订方式">
          ...
          <div slot="footer" class="dialog-footer">
            ...
            <el-button v-if="isEdit" :loading="addBtnLoading" type="" @click="edit()">确 认</el-button>
            <el-button v-if="!isEdit" :loading="addBtnLoading" type="" @click="add()">添 加</el-button>
          </div>
        </el-dialog>
