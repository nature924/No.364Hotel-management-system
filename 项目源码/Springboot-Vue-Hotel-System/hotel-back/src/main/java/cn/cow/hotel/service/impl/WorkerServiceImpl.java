...
import cn.cow.hotel.entity.Department;
import cn.cow.hotel.entity.WorkRole;
import cn.cow.hotel.entity.Worker;
import cn.cow.hotel.mapper.DepartmentMapper;
import cn.cow.hotel.mapper.WorkRoleMapper;
import cn.cow.hotel.mapper.WorkerMapper;
import cn.cow.hotel.service.WorkerService;
import cn.cow.hotel.utils.MD5Utils;
...
public class WorkerServiceImpl implements WorkerService {
    ...
    private Worker buildData(Worker worker) {
        ...
        if (worker.getRoleId() != null) {
            workRole = workRoleMapper.selectById(worker.getRoleId());
        }
        worker.setWorkRole(workRole);
        Department department = null;
        if (worker.getDepartmentId() != null) {
            department = departmentMapper.selectById(worker.getDepartmentId());
        }
